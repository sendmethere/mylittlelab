...
const Method = () => {
    ...
    return (
        ...
        <div className='grid grid-cols-3 gap-2'>
            <div className=' opacity-50 hover:opacity-100 cursor-pointer'  onClick={()=>{setMethod('양적 연구')}}>
            ...
            <div className=' opacity-50 hover:opacity-100 cursor-pointer' onClick={()=>{setMethod('질적 연구')}}>
            ...
            <div className=' opacity-50 hover:opacity-100 cursor-pointer' onClick={()=>{setMethod('혼합 연구')}}>
